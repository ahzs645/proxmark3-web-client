...
function findWasmBinary() {
  return locateFile("proxmark3.wasm");
}
...
var readSockaddr = (sa, salen) => {
  ...
  switch (family) {
    ...
    case 10:
      ...
      addr = [
        (growMemViews(), HEAP32)[(sa + 8) >> 2],
        (growMemViews(), HEAP32)[(sa + 12) >> 2],
        (growMemViews(), HEAP32)[(sa + 16) >> 2],
        (growMemViews(), HEAP32)[(sa + 20) >> 2],
      ];
      addr = inetNtop6(addr);
      break;
    default:
...
function ___syscall_sendto(fd, message, length, flags, addr, addr_len) {
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(17, 0, 1, fd, message, length, flags, addr, addr_len);
  try {
    var sock = getSocketFromFD(fd);
    if (!addr) {
...
var __emscripten_fs_load_embedded_files = (ptr) => {
  do {
    ...
    FS.createDataFile(
      name,
      null,
      (growMemViews(), HEAP8).subarray(content, content + len),
      true,
      true,
      true,
    );
...
var __mktime_js = function (tmPtr) {
  var ret = (() => {
    var date = new Date(
      (growMemViews(), HEAP32)[(tmPtr + 20) >> 2] + 1900,
      (growMemViews(), HEAP32)[(tmPtr + 16) >> 2],
      (growMemViews(), HEAP32)[(tmPtr + 12) >> 2],
      (growMemViews(), HEAP32)[(tmPtr + 8) >> 2],
      (growMemViews(), HEAP32)[(tmPtr + 4) >> 2],
      (growMemViews(), HEAP32)[tmPtr >> 2],
      0,
    );
    ...
    if (dst < 0) {
      (growMemViews(), HEAP32)[(tmPtr + 32) >> 2] = Number(
...
function _getaddrinfo(node, service, hint, out) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(28, 0, 1, node, service, hint, out);
  var addr = 0;
  var port = 0;
  var flags = 0;
  var family = 0;
...
var _pm3_console = (Module["_pm3_console"] = makeInvalidEarlyAccess("_pm3_console"));
var _pm3_grabbed_output_get = (Module["_pm3_grabbed_output_get"] =
  makeInvalidEarlyAccess("_pm3_grabbed_output_get"));
var _pm3_get_current_dev = (Module["_pm3_get_current_dev"] =
  makeInvalidEarlyAccess("_pm3_get_current_dev"));
var _pm3_web_exec = (Module["_pm3_web_exec"] = makeInvalidEarlyAccess("_pm3_web_exec"));
var _pm3_web_exec_opts = (Module["_pm3_web_exec_opts"] =
  makeInvalidEarlyAccess("_pm3_web_exec_opts"));
var _pm3_web_take_output = (Module["_pm3_web_take_output"] =
  makeInvalidEarlyAccess("_pm3_web_take_output"));
var _main = (Module["_main"] = makeInvalidEarlyAccess("_main"));
var _pm3_uart_rx_head_ptr = (Module["_pm3_uart_rx_head_ptr"] =
  makeInvalidEarlyAccess("_pm3_uart_rx_head_ptr"));
var _pm3_uart_rx_tail_ptr = (Module["_pm3_uart_rx_tail_ptr"] =
  makeInvalidEarlyAccess("_pm3_uart_rx_tail_ptr"));
var _pm3_uart_rx_buf_ptr = (Module["_pm3_uart_rx_buf_ptr"] =
  makeInvalidEarlyAccess("_pm3_uart_rx_buf_ptr"));
var _pm3_uart_rx_initialized_ptr = (Module["_pm3_uart_rx_initialized_ptr"] = makeInvalidEarlyAccess(
  "_pm3_uart_rx_initialized_ptr",
));
var _pm3_uart_tx_head_ptr = (Module["_pm3_uart_tx_head_ptr"] =
  makeInvalidEarlyAccess("_pm3_uart_tx_head_ptr"));
var _pm3_uart_tx_tail_ptr = (Module["_pm3_uart_tx_tail_ptr"] =
  makeInvalidEarlyAccess("_pm3_uart_tx_tail_ptr"));
var _pm3_uart_tx_buf_ptr = (Module["_pm3_uart_tx_buf_ptr"] =
  makeInvalidEarlyAccess("_pm3_uart_tx_buf_ptr"));
var _pm3_uart_rb_capacity = (Module["_pm3_uart_rb_capacity"] =
  makeInvalidEarlyAccess("_pm3_uart_rb_capacity"));
var _pm3_uart_stdin_head_ptr = (Module["_pm3_uart_stdin_head_ptr"] = makeInvalidEarlyAccess(
  "_pm3_uart_stdin_head_ptr",
));
var _pm3_uart_stdin_tail_ptr = (Module["_pm3_uart_stdin_tail_ptr"] = makeInvalidEarlyAccess(
  "_pm3_uart_stdin_tail_ptr",
));
var _pm3_uart_stdin_buf_ptr = (Module["_pm3_uart_stdin_buf_ptr"] =
  makeInvalidEarlyAccess("_pm3_uart_stdin_buf_ptr"));
...
var __emscripten_proxy_main = (Module["__emscripten_proxy_main"] =
  makeInvalidEarlyAccess("__emscripten_proxy_main"));
...
var dynCall_jiiiiiiii = makeInvalidEarlyAccess("dynCall_jiiiiiiii");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["pm3_console"] != "undefined", "missing Wasm export: pm3_console");
  assert(
    typeof wasmExports["pm3_grabbed_output_get"] != "undefined",
    "missing Wasm export: pm3_grabbed_output_get",
  );
  assert(
    typeof wasmExports["pm3_get_current_dev"] != "undefined",
    "missing Wasm export: pm3_get_current_dev",
  );
  assert(typeof wasmExports["pm3_web_exec"] != "undefined", "missing Wasm export: pm3_web_exec");
  assert(
    typeof wasmExports["pm3_web_exec_opts"] != "undefined",
    "missing Wasm export: pm3_web_exec_opts",
  );
  assert(
    typeof wasmExports["pm3_web_take_output"] != "undefined",
    "missing Wasm export: pm3_web_take_output",
  );
  assert(
  ...
  assert(
    typeof wasmExports["pm3_uart_rx_head_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_rx_head_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_rx_tail_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_rx_tail_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_rx_buf_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_rx_buf_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_rx_initialized_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_rx_initialized_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_tx_head_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_tx_head_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_tx_tail_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_tx_tail_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_tx_buf_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_tx_buf_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_rb_capacity"] != "undefined",
    "missing Wasm export: pm3_uart_rb_capacity",
  );
  assert(
    typeof wasmExports["pm3_uart_stdin_head_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_stdin_head_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_stdin_tail_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_stdin_tail_ptr",
  );
  assert(
    typeof wasmExports["pm3_uart_stdin_buf_ptr"] != "undefined",
    "missing Wasm export: pm3_uart_stdin_buf_ptr",
  );
  ...
  assert(
    typeof wasmExports["_emscripten_proxy_main"] != "undefined",
    "missing Wasm export: _emscripten_proxy_main",
  );
  assert(
  ...
  assert(
    typeof wasmExports["_emscripten_proxy_poll_finish"] != "undefined",
    "missing Wasm export: _emscripten_proxy_poll_finish",
  );
  assert(
  ...
  assert(
    typeof wasmExports["dynCall_jiiiiiiii"] != "undefined",
    "missing Wasm export: dynCall_jiiiiiiii",
  );
  assert(
  ...
  _pm3_console = Module["_pm3_console"] = createExportWrapper("pm3_console", 4);
  _pm3_grabbed_output_get = Module["_pm3_grabbed_output_get"] = createExportWrapper(
    "pm3_grabbed_output_get",
    1,
  );
  _pm3_get_current_dev = Module["_pm3_get_current_dev"] = createExportWrapper(
    "pm3_get_current_dev",
    0,
  );
  _pm3_web_exec = Module["_pm3_web_exec"] = createExportWrapper("pm3_web_exec", 1);
  _pm3_web_exec_opts = Module["_pm3_web_exec_opts"] = createExportWrapper("pm3_web_exec_opts", 3);
  _pm3_web_take_output = Module["_pm3_web_take_output"] = createExportWrapper(
    "pm3_web_take_output",
    0,
  );
  _main = Module["_main"] = createExportWrapper("__main_argc_argv", 2);
  _pm3_uart_rx_head_ptr = Module["_pm3_uart_rx_head_ptr"] = createExportWrapper(
    "pm3_uart_rx_head_ptr",
    0,
  );
  _pm3_uart_rx_tail_ptr = Module["_pm3_uart_rx_tail_ptr"] = createExportWrapper(
    "pm3_uart_rx_tail_ptr",
    0,
  );
  _pm3_uart_rx_buf_ptr = Module["_pm3_uart_rx_buf_ptr"] = createExportWrapper(
    "pm3_uart_rx_buf_ptr",
    0,
  );
  _pm3_uart_rx_initialized_ptr = Module["_pm3_uart_rx_initialized_ptr"] = createExportWrapper(
    "pm3_uart_rx_initialized_ptr",
    0,
  );
  _pm3_uart_tx_head_ptr = Module["_pm3_uart_tx_head_ptr"] = createExportWrapper(
    "pm3_uart_tx_head_ptr",
    0,
  );
  _pm3_uart_tx_tail_ptr = Module["_pm3_uart_tx_tail_ptr"] = createExportWrapper(
    "pm3_uart_tx_tail_ptr",
    0,
  );
  _pm3_uart_tx_buf_ptr = Module["_pm3_uart_tx_buf_ptr"] = createExportWrapper(
    "pm3_uart_tx_buf_ptr",
    0,
  );
  _pm3_uart_rb_capacity = Module["_pm3_uart_rb_capacity"] = createExportWrapper(
    "pm3_uart_rb_capacity",
    0,
  );
  _pm3_uart_stdin_head_ptr = Module["_pm3_uart_stdin_head_ptr"] = createExportWrapper(
    "pm3_uart_stdin_head_ptr",
    0,
  );
  _pm3_uart_stdin_tail_ptr = Module["_pm3_uart_stdin_tail_ptr"] = createExportWrapper(
    "pm3_uart_stdin_tail_ptr",
    0,
  );
  _pm3_uart_stdin_buf_ptr = Module["_pm3_uart_stdin_buf_ptr"] = createExportWrapper(
    "pm3_uart_stdin_buf_ptr",
    0,
  );
  ...
  __emscripten_proxy_main = Module["__emscripten_proxy_main"] = createExportWrapper(
  ...
  dynCall_jiiiiiiii = dynCalls["jiiiiiiii"] = createExportWrapper("dynCall_jiiiiiiii", 9);
